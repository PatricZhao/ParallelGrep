...
DESCRIPTION
	...
	Such as, for sequential grep one process will scan the whole field from 0 to SIZE. 
	file:     |---------------------------------------------------------|
        size:     0                                                        SIZE   
...
PERFORMANCES
 ...
 ADVANTAGES
        ...
        Reduce the additional costs such as communication time, share memory.

	2) Scalibility and Portability
	Benifit from more threads, suitable for searching big files and huge directories, easy to implement in different ports.
 ...
 DISADVANTAGES
	  ...
	  The sequential algorithm is slower than standard grep.
       ...
       4) Bugs
	   May have potential bugs :( If you find one, email me.
